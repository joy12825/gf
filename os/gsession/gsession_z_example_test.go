...
import (
	...
	"github.com/joy12825/gf/v2/os/gsession"
)
...
func ExampleStorageRedisHashTable_Get() {
	...
	// May Output:
	// <nil>
	// redis adapter is not set, missing configuration or adapter register? possible reference: https://github.com/joy12825/gf/tree/master/contrib/nosql/redis
}
