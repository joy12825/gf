...
func Test_CheckStruct_Recursively_SliceAttribute(t *testing.T) {
	...
	// https://github.com/joy12825/gf/issues/1864
	gtest.C(t, func(t *gtest.T) {
		type Student struct {
			Name string `v:"required"`
			Age  int
...
// https://github.com/joy12825/gf/issues/1983
...
// https://github.com/joy12825/gf/issues/1921
...
// https://github.com/joy12825/gf/issues/2011
