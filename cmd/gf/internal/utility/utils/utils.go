...
func ReplaceGeneratedContentGFV2(folderPath string) (err error) {
	return gfile.ReplaceDirFunc(func(path, content string) string {
		if gstr.Contains(content, `"github.com/joy12825/gf`) && !gstr.Contains(content, `"github.com/joy12825/gf/v2`) {
			content = gstr.Replace(content, `"github.com/joy12825/gf"`, `"github.com/joy12825/gf/v2"`)
			content = gstr.Replace(content, `"github.com/joy12825/gf/`, `"github.com/joy12825/gf/v2/`)
			content = gstr.Replace(content, `"github.com/joy12825/gf/v2/contrib/`, `"github.com/joy12825/gf/contrib/`)
			return content
		}
		return content
	}, folderPath, "*.go", true)
