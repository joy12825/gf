...
# Installation
```
go get -u github.com/joy12825/gf/contrib/config/kubecm/v2
```
...
import (
	"github.com/joy12825/gf/contrib/config/kubecm/v2"
...
Note the top `import`: `_ "github.com/joy12825/gf/example/config/kubecm/boot_in_pod"` .
